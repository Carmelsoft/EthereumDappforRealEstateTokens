...
contract Ownable {
    ...
    event ownershipTransferred(address newAddress);
...
contract Pausable is Ownable {
    ...
    //public setter
    function Pause(bool pauseornot) public onlyOwner {
        _paused = pauseornot;
    }
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Not paused");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Address must not be owner of tokenId");

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == Owner(), "Address must not be owner of tokenId");
...
contract CustomERC721Token is ERC721Metadata("RECapstone", "RECAP", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
